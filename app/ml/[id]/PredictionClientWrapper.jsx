            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSimulatedAttendance(Number(e.target.value))
                  }
          ...
          <div className="bg-gray-900 text-white p-6 rounded-3xl flex flex-col justify-between min-h-[160px]">
            <div>
              ...
              <div className="flex gap-3">
                ...
                <TrendingDown className="text-red-400 shrink-0" size={20} />
                <p className="text-xs sm:text-sm leading-relaxed">
                  The student's performance in <strong>{weakest.name}</strong>{" "}
                  is the primary factor dragging down the prediction. Focusing
                  on this area could improve the final grade by up to{" "}
                  <strong>{Math.abs(weakest.impact).toFixed(1)} points</strong>.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-6">
            <div>
              <h3 className="text-xl font-black tracking-tight flex items-center gap-2 text-gray-900">
                <TrendingDown
                  size={24}
                  className="text-indigo-600 rotate-180"
                />
